...
This article compares the impact of internal and external mobility on worker outcomes. Internal mobility types have largely been ignored in recent debates. As a result, studies of job mobility have largely focused on who experiences job quits or job hopping (Gesthuizen; Steenacker), and what are the returns to job quits or job hopping (Ruiz; kronberg). This approach has a tendnecy to frame mobile working lives as stemming from workers shopping for better opportunities elsewhere (Brown et al., 2008, OECD, 2010). This view tends to minimise precarity, and ignore the fact that internal, traditional, channels for career progression often carry the best rewards for workers. 
...
The reservation wage, which drives worker mobility to new positions, appears to be at play for internal mobility decisions (Burdett 197x). External mobility types seem to stem from poor hours, poor conditions, and poor satisfaction. Once the consequences of external mobility are better understood, it is hard to see such mobility types as leading workers to progressively "better" jobs. 
